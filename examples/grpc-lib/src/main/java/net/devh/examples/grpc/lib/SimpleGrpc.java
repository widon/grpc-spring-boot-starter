...
public final class SimpleGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<net.devh.examples.grpc.lib.HelloRequest,
      net.devh.examples.grpc.lib.HelloReply> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "SayHello",
      requestType = net.devh.examples.grpc.lib.HelloRequest.class,
      responseType = net.devh.examples.grpc.lib.HelloReply.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<net.devh.examples.grpc.lib.HelloRequest,
      net.devh.examples.grpc.lib.HelloReply> getSayHelloMethod() {
    io.grpc.MethodDescriptor<net.devh.examples.grpc.lib.HelloRequest, net.devh.examples.grpc.lib.HelloReply> getSayHelloMethod;
      ...
      synchronized (SimpleGrpc.class) {
        if ((getSayHelloMethod = SimpleGrpc.getSayHelloMethod) == null) {
          SimpleGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<net.devh.examples.grpc.lib.HelloRequest, net.devh.examples.grpc.lib.HelloReply>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "Simple", "SayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.devh.examples.grpc.lib.HelloRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  net.devh.examples.grpc.lib.HelloReply.getDefaultInstance()))
  ...
  private static abstract class SimpleBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return net.devh.examples.grpc.lib.HelloWorldProto.getDescriptor();
    }
